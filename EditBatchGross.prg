...
PROCEDURE editBatchGross (oWnd, CntrlGross, CntrlFed, CntrlSt, CntrlCount, BatchGross, BatchFed, BatchSt, BatchCount,BtnLoad)
   ...
   if (nBatchGross = nCntrlGross) .AND. ;
      ...
      oMB:setWindowTitle( "Gross Winnings Edit" )
   ...
   CntrlGross:SetText(Transform( nCntrlGross, "##,###,###,##9.99" ))
