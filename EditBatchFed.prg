...
PROCEDURE editBatchFed (oWnd, CntrlGross, CntrlFed, CntrlSt, CntrlCount, BatchGross, BatchFed, BatchSt, BatchCount,BtnLoad)
   ...
   if (nBatchGross = nCntrlGross) .AND. ;
      ...
      oMB:setWindowTitle( "Federal Withholding Edit" )
   ...
   CntrlFed:SetText(Transform( nCntrlFed, "##,###,###,##9.99" ))
   RETURN
