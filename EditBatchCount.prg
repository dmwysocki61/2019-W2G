#include "hbqtgui.ch"
PROCEDURE editBatchCount (oWnd, CntrlGross, CntrlFed, CntrlSt, CntrlCount, BatchGross, BatchFed, BatchSt, BatchCount,BtnLoad)
      ...
      otMessage        := "Batch in Balance. " + chr(13) + chr(10) + " " + chr(13) + chr(10) + "Click Load Button to upload to database."
      otDetail         := ""
      ...
      if (nBatchGross = nCntrlGross) .AND. ;
         ...
         oMB:setWindowTitle( "Batch Count Edit" )
      ...
      CntrlCount:SetText(Transform( nCntrlCount, "###,##9.99" ))
   RETURN
